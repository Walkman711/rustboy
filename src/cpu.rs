...
impl CPU {
    ...
    fn decode(&mut self, opcode: u8) -> Inst {
        match opcode {
            ...
            0x09 => Inst::ADD16(Dst16::HL, Src16::BC, 8),                            // ADD HL,BC
            ...
            0x17 => Inst::RLA(4),                                                    // RLA
            0x18 => unimplemented!("{:#04x}", opcode),                               // JR r8
            0x19 => Inst::ADD16(Dst16::HL, Src16::DE, 8),                            // ADD HL,DE
            ...
            0x1F => Inst::RRA(4),                                                    // RRA
            0x20 => unimplemented!("{:#04x}", opcode),                               // JR NZ,r8
            ...
            0x27 => Inst::DAA(4),                                                    // DAA
            0x28 => unimplemented!("{:#04x}", opcode),                               // JR Z,r8
            0x29 => Inst::ADD16(Dst16::HL, Src16::HL, 8),                            // ADD HL,HL
            ...
            0x2F => Inst::CPL(4),                                                    // CPL
            0x30 => unimplemented!("{:#04x}", opcode),                               // JR NC,r8
            ...
            0x37 => Inst::SCF(4),                                                    // SCF
            0x38 => unimplemented!("{:#04x}", opcode),                               // JR C,r8
            0x39 => Inst::ADD16(Dst16::HL, Src16::SP, 8),                            // ADD HL,SP
            ...
            0xDA => Inst::JPC(Src16::NN, Flags::C, true, 16),                        // JP C,a16
            0xDC => Inst::CALLC(Flags::C, true, 24),                                 // CALL C,a16
    ...
    fn decode_cb(&mut self) -> Inst {
        ...
        match opcode {
            ...
            0x40 => Inst::BIT(self.fetch_byte(), Dst8::B, 8),           // BIT b, B
            0x41 => Inst::BIT(self.fetch_byte(), Dst8::C, 8),           // BIT b, C
            0x42 => Inst::BIT(self.fetch_byte(), Dst8::D, 8),           // BIT b, D
            0x43 => Inst::BIT(self.fetch_byte(), Dst8::E, 8),           // BIT b, E
            0x44 => Inst::BIT(self.fetch_byte(), Dst8::H, 8),           // BIT b, H
            0x45 => Inst::BIT(self.fetch_byte(), Dst8::L, 8),           // BIT b, L
            0x46 => Inst::BIT(self.fetch_byte(), Dst8::HLContents, 16), // BIT b, (HL)
            0x47 => Inst::BIT(self.fetch_byte(), Dst8::A, 8),           // BIT b, A
